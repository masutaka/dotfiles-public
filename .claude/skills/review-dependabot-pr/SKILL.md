...
description: ghro CLI で Dependabot PR をレビューし、tmp/docs/pr-review-{PR番号}.md にまとめる
---
...
2. PR の body
3. Release Notes / CHANGELOG（body にリンクがあれば ghro CLI や WebFetch で確認）
